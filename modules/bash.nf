...
process read_length {
    ...
    script:
        ...
        echo \$READLENGTH > ${meta.file_id[0]}${meta.suffix}_read_length.txt
        """
}
    ...
    script:
        ...
        if ( "bowtie" in aligner_list ){
            if (meta.read_type == "pacbio" || meta.read_type == "ont"){
                log.info "${meta.uid} => Bowtie aligner is not recommended to align long reads!"
            }
        }
        ...
        if ( "bowtie2" in aligner_list ){
            if (meta.read_type == "pacbio" || meta.read_type == "ont"){
                log.info "${meta.uid} => Bowtie2 aligner is not recommended to align long reads!"
            }
        }
        ...
        if ( "bwaaln" in aligner_list ){
            if ( meta.read_type == "pacbio" || meta.read_type == "ont"){
                log.info "${meta.uid} => Bwaaln aligner is not recommended to align long reads!"
            }
        }
        ...
        if ( "dragmap" in aligner_list ){
            if (meta.read_type == "pacbio" || meta.read_type == "ont"){
                log.info "${meta.uid} => Dragmap aligner is not recommended to align long reads!"
            }
        }
        ...
        if ( "graphmap2" in aligner_list ){
            if ( meta.read_type == "short_single" && meta.read_type == "short_paired"){
                log.info "${meta.uid} => Graphmap2 aligner is not recommended to align short reads!"
            }
        }
        ...
        if ("hisat2" in aligner_list ){
            if (meta.read_type == "pacbio" || meta.read_type == "ont"){
                log.info "${meta.uid} => Hisat2 aligner is not recommended to align long reads!"
            }
        }
        ...
        if ( "kallisto" in aligner_list ){
            if ( meta.read_type == "pacbio" || meta.read_type == "ont"){
                log.info "${meta.uid} => Kallisto aligner is not recommended to align long reads!"
            }
        }
        ...
        if ( "last" in aligner_list ){
            if ( meta.read_type == "short_single" && meta.read_type == "short_paired"){
                log.info "${meta.uid} => Last aligner is not recommended to align short reads!"
            }
        }
        ...
        if ("ngmlr" in aligner_list ){
            if ( meta.read_type == "short_single" && meta.read_type == "short_paired"){
                log.info "${meta.uid} => Ngmlr aligner is not recommended to align short reads!"
            }
        }
        ...
        if ("novoalign" in aligner_list ){
            if ( meta.read_type == "ont"){
                log.info "${meta.uid} => Novoalign aligner is not recommended to align long reads!"
            }
        }
        ...
        if ("nucmer" in aligner_list ){
            if ( meta.read_type == "pacbio" || meta.read_type == "ont"){
                log.info "${meta.uid} => Nucmer aligner is not recommended to align long reads!"
            }
        }
        ...
        if ( "salmon" in aligner_list ){
            if ( meta.read_type == "ont" || meta.read_type == "pacbio"){
                log.info "${meta.uid} => Salmon aligner is not recommended to align long reads!"
            }
        }
        ...
        if ( "subread" in aligner_list ){
            if (meta.read_type == "pacbio" || meta.read_type == "ont"){
                log.info "${meta.uid} => Subread aligner is not recommended to align long reads!"
            }
        }
        ...
        if ( "sublong" in aligner_list ){
            if ( meta.read_type == "short_single" || meta.read_type == "short_paired"){
                log.info "${meta.uid} => Sublong aligner is not recommended to align short reads!"
            }
        }
...
process check_aligner_params{
    ...
    script:
        // Modify meta directly - Nextflow handles this correctly for caching
